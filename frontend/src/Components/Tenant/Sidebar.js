    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-200">
          <h1 className={`text-xl font-bold text-sky-500 transition-all duration-200 ${collapsed && 'hidden'}`}>
            RentEase
          </h1>
        ...
        <nav className="flex flex-col gap-1 p-2">
          ...
          {/* Logout */}
          <button
            className="flex items-center gap-3 text-red-500 px-3 py-2 mt-4 rounded-md hover:bg-red-50 transition"
          >
